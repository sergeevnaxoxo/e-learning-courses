    ...
    <div class="row-fluid">
        ...
        <div class="box black span12 noMargin" onTablet="span12" onDesktop="span12">
            ...
            <div class="box-content">
                <form method="post" action="{{url('/emptywords')}}">
                    @csrf
                    <div class="field">
                        <p class="th1" align="center"><b style="color:black">(РЕКОМЕНДОВАНО: в тексте задания на месте пропущенного слова укажите пропуск в виде "[Номер пропущеного слова]") </b></p>
