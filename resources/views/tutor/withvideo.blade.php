    ...
    <div class="row-fluid">
        ...
        <div class="box black span12 noMargin" onTablet="span12" onDesktop="span12">
            ...
            <div class="box-content">
                <form method="post" action="{{url('/withvideo')}}" enctype=multipart/form-data>
                    @csrf
                    <div class="field">
                        ...
                        <p align="center" style="color: black;">Загрузите видео файл <input name="video" type="file"></p>
                        <p align="center"><b style="color: black;">Ответ: </b><input type="text" name="answeqr" placeholder="Добавьте ответ"></p>
                    </div>
