        ...
        <div class="navbar-inner">
            <div class="container-fluid">
                ...
                <div class="nav-no-collapse header-nav">
                    ...
                    @include('student.dropdownmycourse')
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a href="/edit-profile-student"><i class="halflings-icon user"></i> Профиль</a></li>
            ...
            <div id="sidebar-left" class="span2">
                <div class="nav-collapse sidebar-nav">
                    <ul class="nav nav-tabs nav-stacked main-menu">
                        <li><a href="/home-student"><i class="icon-list-alt"></i><span class="hidden-tablet"> Главная</span></a></li>
                        <li><a href="/apply-courses"><i class="icon-external-link"></i><span class="hidden-tablet"> Записаться на курс</span></a></li>
                        <li><a href="/my-courses"><i class="icon-briefcase"></i><span class="hidden-tablet">Мой куры</span></a></li>
                    </ul>
                </div>
            </div>
            <!-- end: Main Menu -->
