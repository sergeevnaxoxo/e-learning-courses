                    ...
                    <ul class="nav pull-right">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a href="/edit-profile-admin"><i class="halflings-icon user"></i> Профиль</a></li>
        ...
        <div id="sidebar-left" class="span2">
                <div class="nav-collapse sidebar-nav">
                    <ul class="nav nav-tabs nav-stacked main-menu">
                        <li><a href="/home-admin"><i class="icon-list-alt"></i><span class="hidden-tablet"> Главная</span></a></li>
                    </ul>
                </div>
            </div>
